...
$title='Accounts Using The Same PC';
admin_login();
...
$report=mysql_query("select computerid,count(*) as count from ".mysql_prefix."last_login,".mysql_prefix."users where ".mysql_prefix."users.username=".mysql_prefix."last_login.username and computerid!='' and account_type!='canceled' group by computerid order by count desc");
