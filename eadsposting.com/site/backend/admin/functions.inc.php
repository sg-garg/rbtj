<?php
//LDF SCRIPTS
define ('BACKEND_PATH',dirname(dirname(__FILE__)));
require_once BACKEND_PATH.'/conf.inc.php';
require_once BACKEND_PATH.'/functions.inc.php';
...
function postsysval()
	{
    	if ($_POST['sysval'])
		{
    		...
    		{
            	@mysql_query("replace into system_values set name='$key',value='".mysql_real_escape_string(trim($value))."'");
