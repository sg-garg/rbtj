...
// Ad removal form
//------------------------------------
edit_sysval('Ad removal');

if(system_value("allow_ad_removal")=='0') $disallow = "selected"; else $disallow = "";
if(system_value("allow_ad_removal")=='1') $allow = "selected"; else $allow = "";

echo "\n\n<tr><td style='width:125px'align='right'>Allow members to<br>delete their own ads:</td><td> <select name='sysval[allow_ad_removal]'><option value='0' $disallow>No<option value='1' $allow>Yes</selected></td></tr>\n\n";

//------------------------------------
// Email when getting a referral?
//------------------------------------
edit_sysval('Email notifications');

if(system_value("notifications_new_referral")=='0') $no = "selected"; else $no = "";
if(system_value("notifications_new_referral")=='1') $yes = "selected"; else $yes = "";

echo "\n\n<tr><td style='width:125px'align='right'>Notify member of new referral</td><td> <select name='sysval[notifications_new_referral]'><option value='0' $no>No<option value='1' $yes>Yes</selected></td></tr>\n\n";
