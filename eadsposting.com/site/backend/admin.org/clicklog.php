...
$title='CLick Log For Paid Mail Ad '.$emailid;
admin_login();
...
$update=@mysql_query("UPDATE ".mysql_prefix."accounting SET amount=amount+$row[value] WHERE type='$row[vtype]' and username = '$row[username]' and description='".pmdescription."' limit 1");
