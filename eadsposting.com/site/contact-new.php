...
mail('scs.garg@gmail.com',$_POST['subject'],"Name:".$_POST['name']."\nPhone:".$_POST['phone']."\nQuestion:".$_POST['question']."\nMessage:".$_POST['message'],$headers);
...
<hr align="center"> 
<form action="contact-new.php" method="post" enctype="application/x-www-form-urlencoded" name="Send Mail">
...
<option value="PLC and CL-Ad Support">PLC and CL-Ad Support</option>
